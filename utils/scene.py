    ...
    def __init__(self, gridlines_on=None, gridlines_width=None, gridlines_spacing=None):
        ...
        self.background_prims.append(
            Tri([(background_lower_bound, 0, background_upper_bound),
                ...
                (background_lower_bound, 0, background_upper_bound)]))
        self.background_prims.append(
        ...
        if gridlines_on:
               for i in range((background_upper_bound - background_lower_bound) / (gridlines_width + gridlines_spacing)):
                   offset = i * (gridlines_width + gridlines_spacing)
                   shapes.append(Tri([(background_lower_bound + offset, 0, background_lower_bound),
                                        (background_lower_bound + offset, 0, background_upper_bound),
                                        (background_lower_bound + gridlines_spacing + offset, 0, background_lower_bound)]))
                   shapes.append(Tri([(background_lower_bound + offset, 0, background_upper_bound),
                                        (background_lower_bound + gridlines_spacing + offset, 0, background_upper_bound),
                                        (background_lower_bound + gridlines_spacing + offset, 0, background_lower_bound)]))
